...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/metview-python-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12681&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/metview-python-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `metview-python` can be installed with:

```
conda install metview-python
```

It is possible to list all of the versions of `metview-python` available on your platform with:
